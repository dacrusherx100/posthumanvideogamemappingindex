Hello :), so eventually this is a research index which I will eventually be moving to a github hosted website, hence the github link.  Though, for now, here is a Google Slides link containing said index.
